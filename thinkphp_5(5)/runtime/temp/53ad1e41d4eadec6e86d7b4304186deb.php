<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\wamp64\www\think\game\thinkphp_5\public/../application/index\view\login\index.html";i:1508911479;}*/ ?>
...
<link id="css" rel="stylesheet" type="text/css" href="__CSS__/zclc2.1460959081.css" />
<script>
    var use_min_js = 0;
</script>
<script type="text/javascript" src="__jS__/sea.js" id="seajsnode"></script>
<script type="text/javascript" src="__jS__/sea.config.js"> </script>
...
<div class="head_foot_content">
    <div class="header">
        ...
        <div class="content-bd" status="available">
            ...
            <div class="line"></div>
            <div class="content-r">
                <form action="dologin" method="post" onsubmit="return false;">
                    ...
                    <div class="box">
                        ...
                        <input style="margin-bottom: 0" id="userIdTxt" type="text" placeholder="" ="你的手机号/邮箱" name="userid" class="email" jvdefault="你的手机号/邮箱" jvcorrecttip='' jvtipid="userIdSpt" maxlength="50" jvpattern="^.{1,50}$" jverrortip="请输入注册时用的邮箱或者手机号呀" />
                    </div>
                    <div class="box">
                    ...
                    <div class="box">
                        ...
                        <i></i> <img id="verify_img"  src="<?php echo captcha_src(); ?>" style="float: right;width: 200px;" alt="captcha" onclick="refreshVerify()"/>
...
$('.login').on('click',function(){
  ...
  {
    $.post("/index/login/dologin",{"username":username,"password":password},function(data){
            if(data.status){
              location.href = '/';
            }
    });
