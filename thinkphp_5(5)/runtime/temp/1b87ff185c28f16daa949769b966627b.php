<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\wamp64\www\think\game\thinkphp_5\public/../application/index\view\index\index.html";i:1508929170;s:87:"D:\wamp64\www\think\game\thinkphp_5\public/../application/index\view\public\header.html";i:1508915152;s:87:"D:\wamp64\www\think\game\thinkphp_5\public/../application/index\view\public\footer.html";i:1508924980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
   ...
   //$('document').on('ready',function(){
    $('document').ready(function(){
      ...
      $.post("/index/index/getTop",{'tid':3},function(data){
        ...
        for (var i = 0; i < data.length; i++) {
          $("#top1").append('<li class="item item-one"><a href=/index/Radioinfo/show?id='+data[i]['vid']+'><i class="n1">'+(i+1)+'</i><img src='+data[i].img_src+' alt="#"><div><p class="title">'+data[i].title+'</p><p class="mark">综合评分: 109.3万</p></div></a></li>');
        }
      });
      ...
      $.post("/index/index/getTop",{'tid':4},function(data){
        ...
        for (var i = 0; i < data.length; i++) {
          $("#top2").append('<li class="item item-one"><a href=/index/Radioinfo/show?id='+data[i]['vid']+'><i class="n1">'+(i+1)+'</i><img src='+data[i].img_src+' alt="#"><div><p class="title">'+data[i].title+'</p><p class="mark">综合评分: 109.3万</p></div></a></li>');
        }
      });
    });
