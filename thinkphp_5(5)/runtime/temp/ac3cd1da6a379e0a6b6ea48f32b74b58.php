<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\wamp64\www\game\thinkphp_5\public/../application/admin\view\admin\product_list.html";i:1508919502;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<!-- <td class="va-t"><IFRAME  ID="testIframe"Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100% height=390px SRC="<?php echo url('admin/adminuser/product_category_add'); ?>"></IFRAME></td> -->
			...
			if (treeNode.isParent) {
				...
				// alert(3);
				 //demoIframe.attr('<a href='+product_category_add+'?tid='+treeNode.id+'></a>');
				  $.ajax({
				 "url":"<?php echo url('admin/adminuser/product_category_addd'); ?>",
				 type: 'post',
...
function showCode(str) {
  ...
  //修改节点信息
    function beforeRename(treeId, treeNode, newName) {
            ...
            $.ajax({
				 "url":"<?php echo url('admin/adminuser/xiugai_type'); ?>",
				 type: 'post',
				 dataType: 'json',
				data:{
					"tid":treeInfo,
  ...
  //删除节点信息
        function beforeRemove(treeId, treeNode) {
            ...
            if (confirm("确认删除 节点 -- " + treeNode.name + " 吗？")) {
                ...
                var treeInfo = treeNode.id;
	                $.ajax({
						 "url":"<?php echo url('admin/adminuser/del_type'); ?>",
						 type: 'post',
						 dataType: 'json',
						data:{
							"tid":treeInfo
...
function addHoverDom(treeId, treeNode) {  
    ...
    if (btn) btn.bind("click", function(){  
        ...
        $.ajax({  
            ...
            url : "<?php echo url('admin/adminuser/add_type'); ?>",    
            data :    
            {    
                "name" : "新部门"+newCount,  
...
function genjiedian()
{
	count++;
	 $.ajax({  
            ...
            url : "<?php echo url('admin/adminuser/add_gen'); ?>",    
            data :    
            {    
                "name" : "新部门"+count,  
...
$(document).ready(function(){
	var zNodes =new Array();
	 $.ajax({
		 "url":"<?php echo url('admin/adminuser/jsonlist'); ?>",
		 type: 'post',
		 dataType: 'json',
...
function product_del(obj,id){
    ...
    ,yes: function(index){
        //alert(1);
        $.ajax({
            url:"<?php echo url('admin/adminuser/videohuishou'); ?>",
            data:{'id':id},
            type:"Post",
            dataType:"json",
