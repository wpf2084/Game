<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"D:\wamp64\www\game\thinkphp_5\public/../application/index\view\index\index.html";i:1508977670;s:81:"D:\wamp64\www\game\thinkphp_5\public/../application/index\view\public\header.html";i:1508915152;s:81:"D:\wamp64\www\game\thinkphp_5\public/../application/index\view\public\footer.html";i:1508924980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <link rel="stylesheet" type="text/css" href="__CSS__/home.css">
   <link rel="stylesheet" type="text/css" href="__CSS__/dastyle.css">
  <!-- bootstrap -->
    ...
    <script type="text/javascript" src="__BOOTSTRAP__/js/jquery-1.12.4.js"></script>
     <script type="text/javascript" src="__BOOTSTRAP__/js/bootstrap.min.js"></script>
      ...
      <script type="text/javascript" src="___JS__/FreeZoomer.js"></script>
     <!-- QQ -->
...
<body>
 ...
 <nav id="nav">
    ...
    <div class="page-width clearfix">
      <div class="slider fl">
        <div class="slider-img">
          <a href="#" slider-title="pic1"><img  src="__IMAGES__/cont/slider_img1.png" alt="#"></a>
          <a href="#" slider-title="pic2"><img   src="__IMAGES__/cont/slider_img2.png" alt="#"></a>
          <a href="#" slider-title="pic3"><img   src="__IMAGES__/cont/slider_img3.png" alt="#"></a>
          <a href="#" slider-title="pic4"><img   src="__IMAGES__/cont/slider_img4.png" alt="#"></a>
        </div>
      ...
      <div class="banner-list fr" id="bannerfa">
        <ul>
        ...
        <span href="#" class="btn btn-prev">昨<br />日</span>
        <span href="#" class="btn btn-next">一<br />周</span>
      </div>
    </div>
  </div>
    ...
    <div class="page-width">
      ...
      <div class="mainCont clearfix" id="animation" js-move="true">
        ...
        <div class="main-side fr" js-tab="true">
          ...
          <div class="main-side__cont">
            <div class="tab-cont">
              <ul class="tab-cont__item main-rank" id="top1">
              <div class="storey-box clearfix">
                     <div class="load-state">
                        <span class="loading">正在加载....</span>
              </div>
      ...
      <div class="mainCont clearfix" id="movie" js-move="true">
        ...
        <div class="main-side fr" js-tab="true">
          ...
          <div class="main-side__cont">
            <div class="tab-cont">
              <ul class="tab-cont__item main-rank" id="top2">
                <div class="storey-box clearfix">
                     <div class="load-state">
                        <span class="loading">正在加载....</span>
                 </div>
  ...
  <input type="hidden" value="<?php echo $count; ?>" name="hiddencoun">
  <script type="text/javascript" src="__JS__/banner.js"></script>
<script type="text/javascript">
  var page = 1;
  var bannerlist = $("#bannerfa");
  var prev = $(".btn-prev");
  var next = $(".btn-next");
  var count = $("input[name=hiddencoun]").val();
  ...
  $('html,body').animate({scrollTop: '0px'}, 800);}); 
   ...
   //$('document').on('ready',function(){
    $('document').ready(function(){
      ...
      function(data)
      {
        bannerlist.children('ul').children().remove();
        var doto = data.data;
        for(var i=0;i<doto.length;i++){
          bannerlist.children('ul').append("<li><a href=/index/Radioinfo/show?id="+doto[i]['vid']+"><img src="+doto[i]['img_src']+" ><div class='info'><p class='title'>"+doto[i]['title']+"</p><p class='author'>UP主:"+doto[i]['nickname']+"</p><p class='play'>播放:"+doto[i]['count']+"</p></div></a></li>");
        }
      }
      );
      ...
      $.post(
        ...
        function(data)
        {
          ...
          for (var i = 0; i < data.length; i++) {
              $("#animate_list").append('<li class="item item-one"><a href=/index/Radioinfo/show?id='+data[i]['vid']+' class="img-link"><img src='+data[i].img_src+' alt="#"><span class="mask"></span><span class="time">3:39</span></a><div class="img-info"><a href="#">'+data[i].title+'~</a><div class="btm"><div class="user"><i></i>'+data[i].nickname+'</div><div class="online"><i></i>'+data[i].count+'</div></div></div></li>');
          }
        }
        );

      $.post(
        "/index/index/getMovie",
        function(data)
        {
          $("#movie_list").children().remove();
          for (var i = 0; i < data.length; i++) {
              $("#movie_list").append('<li class="item"><a href=/index/Radioinfo/show?id='+data[i]['vid']+'  class="img-link"><img src='+data[i].img_src+' alt="#"><span class="mask"></span><span class="time">3:39</span></a><div class="img-info"><a href="#">'+data[i].title+'~</a><div class="btm"><div class="user"><i></i>'+data[i].nickname+'</div><div class="online"><i></i>'+data[i].count+'</div></div></div></li>');
          }
        }
        );

      $.post("/index/index/getTop",{'tid':3},function(data){
        $("#top1").children().remove();
        for (var i = 0; i < data.length; i++) {
          $("#top1").append('<li class="item item-one"><a href=/index/Radioinfo/show?id='+data[i]['vid']+'><i class="n1">'+(i+1)+'</i><img src='+data[i].img_src+' style="width:50px" alt="#"><div><p class="title">'+data[i].title+'</p><p class="mark">综合评分: 109.3万</p></div></a></li>');
        }
      });

      $.post("/index/index/getTop",{'tid':4},function(data){
        $("#top2").children().remove();
        for (var i = 0; i < data.length; i++) {
          $("#top2").append('<li class="item item-one"><a href=/index/Radioinfo/show?id='+data[i]['vid']+'><i class="n1">'+(i+1)+'</i><img src='+data[i].img_src+' style="width:50px" alt="#"><div><p class="title">'+data[i].title+'</p><p class="mark">综合评分: 109.3万</p></div></a></li>');
        }
      });
    });
