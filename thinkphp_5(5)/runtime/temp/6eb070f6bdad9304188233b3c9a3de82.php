<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"D:\wamp64\www\think\game\thinkphp_5\public/../application/index\view\movie\index.html";i:1508930261;s:87:"D:\wamp64\www\think\game\thinkphp_5\public/../application/index\view\public\header.html";i:1508915152;s:87:"D:\wamp64\www\think\game\thinkphp_5\public/../application/index\view\public\footer.html";i:1508924980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
    ...
    <div class="page-width">
      ...
      <div class="mainCont clearfix" id="movie" js-move="true">
        <div class="pic-list fl" js-tab="true">
          ...
          <ul id="cnmovie_list" class="pic-list__wrapper clearfix tab-cont__item tab-cont__cur">
                <div class="storey-box clearfix">
                     <div class="load-state">
                        <span class="loading">正在加载....</span>
                    </div>
      ...
      $.post(
        ...
        function(data)
        {
          ...
          for (var i = 0; i < data.length; i++) {
            ...
            {
                $("#cnmovie_list").append('<li class="item"><a href=/index/Radioinfo/show?id='+data[i]['vid']+' class="img-link"><img src='+data[i].img_src+' alt="#"><span class="mask"></span><span class="time">3:39</span></a><div class="img-info"><a href="#">'+data[i].title+'~</a><div class="btm"><div class="user"><i></i>'+data[i].nickname+'</div><div class="online"><i></i>6732</div></div></div></li>');
            }
          }
        }
        );
