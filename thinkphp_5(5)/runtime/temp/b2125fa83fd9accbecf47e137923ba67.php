<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\wamp64\www\game\thinkphp_5\public/../application/index\view\userall\upload_head.html";i:1508914651;s:81:"D:\wamp64\www\game\thinkphp_5\public/../application/index\view\public\header.html";i:1508915152;s:81:"D:\wamp64\www\game\thinkphp_5\public/../application/index\view\public\footer.html";i:1508924980;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
            ...
            <div class="mainbox" style="position: relative;">
                <div class="zytop clear">
                    <div class="adminzy fleft">
                        <div class="adminnametext"><?php echo \think\Request::instance()->session('user.nickname'); ?><span>1点赞币：<strong>0</strong>个</span></div>
                        <div class="adminmood fonthui">来说点什么吧~~</div>
                    </div><br>
                    <form action='<?php echo url("index/userall/doupload"); ?>' id="uploadimg" method="post" enctype="multipart/form-data">
                    <div style="width: 500px" id="upload_head">
                            <label class="fileLabel" for="upfiles" style=" display: inline-block;width:180px;height: 50px;line-height: 20px;text-align: center;border: 1px solid #8cc051;border-radius: 5px;background: #f1f2f5;cursor: pointer; margin-left: 200px;">选择头像</label>
                            <input id="upfiles" name="image" type="file" class="fileInput" style="display: none">
                            <img src="<?php echo (\think\Request::instance()->session('user.img')) ? \think\Request::instance()->session('user.img') :  '//static.hdslb.com/images/member/noface.gif'; ?>"  id="newimg" style="margin-left:211px;margin-top:10px;width:150px;height:150px;"></img>
                            <input type="submit" name="uploadbtn" class="btn btn-primary" style="position: absolute;bottom: 0px;left: 238px;display: none;" name="upload"  value="更新">
                    </div>
                     </form>
                </div>
