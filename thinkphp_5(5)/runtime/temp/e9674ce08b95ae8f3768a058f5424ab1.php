<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\wamp64\www\game\thinkphp_5\public/../application/admin\view\admin\welcome.html";i:1508899244;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20" style="padding-top:20px;">
  <p class="f-20 text-success">欢迎使用BB.admin <span class="f-14">666</span>后台！</p>
  <p>登录次数：18 </p>
...
<!--   <form action=""method="post">
  ...
  <input type="radio" name="zhandian"/>关闭站点
   <input type="radio" name="zhandian"/>开启站点
   <input style="background:pink;margin-top: 70px;margin-left: -110px;margin-bottom: 20px"type="submit"value="提交"/>
   </div>
   </form> -->
