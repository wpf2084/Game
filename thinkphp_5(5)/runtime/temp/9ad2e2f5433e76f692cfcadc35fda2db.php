<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\wamp64\www\game\thinkphp_5\public/../application/admin\view\admin\pinglun_list.html";i:1508835462;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php if(!empty($pinglist)): foreach($pinglist as $key=>$val): if($val['recovery']==1): ?>
			<tr class="text-c">
				<td><input type="checkbox" value="<?php echo $val['id']; ?>" name=""></td>
				<td><?php echo $val['id']; ?></td>
				<td><?php echo $val['contents']; ?></u></a></td>
			
				<td><?php echo date("y-m-d",$val['create_time']); ?></td>
				<td><?php echo $val['p_username']; ?></td>
				
				
				<!-- <td class="td-status"><span class="label label-success radius">已启用</span></td> -->
				<td class="td-manage">
				<!-- <a style="text-decoration:none" onClick="member_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a>  -->
				 <a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo $val['id']; ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
			<?php endif; endforeach; endif; ?>
		</tbody>
	</table>
	</div>
		<div class="paging"><?php echo $pinglist->render(); ?></div>
		<!-- <ul class="pagination">
...
function member_del(obj,id){
    ...
    ,yes: function(index){
        //alert(1);
        $.ajax({
            url:"<?php echo url('admin/adminuser/pinghui'); ?>",
            data:{'id':id},
            type:"Post",
            dataType:"json",
